module.exports = {
  ...
  embed: {
    color: process.env.color || "#F8F8FF",
    wrongcolor: process.env.wrongcolor || "#8a0808",
    footertext: "เข้ารหัสโดย Doralaikon_TH",
  },
  emoji: {
    ERROR: "❌",
    SUCCESS: "✅",
  ...
  links: {
    inviteURL:
      ...
      `https://discord.gg/7G5cPjwGxW`,
    DiscordServer: process.env.DiscordServer || `https://discord.gg/7G5cPjwGxW`,
    VoteURL: process.env.VoteURL || `https://discord.gg/7G5cPjwGxW`,
    Website: `https://discord.gg/7G5cPjwGxW`,
  },
  options: {
    embedFooter: true,
    nowplayingMsg: true,
