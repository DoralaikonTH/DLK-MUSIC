...
module.exports = {
  ...
  options: [
    {
      name: "เพลง",
      description: `พิมพ์ลิงก์หรือชื่อเพลงที่จะเล่นครับ`,
  ...
  run: async (client, interaction, args, queue) => {
    // Code
    let query = interaction.options.getString("เพลง");
    ...
    let embed = new EmbedBuilder()
      ...
      .setTitle(`\`${query}\` ผลการค้นหาตามนี้ครับ`)
      ...
      .then(async (msg) => {
        ...
        collector.on("collect", async (interaction) => {
          if (interaction.isStringSelectMenu()) {
            ...
            if (interaction.customId === "ค้นหาเพลง") {
